 ...
 * on 2018-01-28 at 19:42:55 UTC 
 * Modify at your own risk.
 */

package com.example.vikra.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.example.vikra.myapplication.backend.myApi.model.MyBean}
   * @return the request
   */
  public SetJoke setJoke(com.example.vikra.myapplication.backend.myApi.model.MyBean content) throws java.io.IOException {
    SetJoke result = new SetJoke(content);
    initialize(result);
    return result;
  }

  public class SetJoke extends MyApiRequest<com.example.vikra.myapplication.backend.myApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected SetJoke(com.example.vikra.myapplication.backend.myApi.model.MyBean content) {
      super(MyApi.this, "POST", REST_PATH, content, com.example.vikra.myapplication.backend.myApi.model.MyBean.class);
    }
